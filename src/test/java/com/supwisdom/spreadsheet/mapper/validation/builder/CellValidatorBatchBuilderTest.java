...
public class CellValidatorBatchBuilderTest {
  ...
  public void testBuilder() throws Exception {
    ...
    List validators = builder
        ...
        .start(LocalDateTimeValidatorFactory.getInstance())
        .errorMessage("test")
        .group("t3")
        .matchFields("t3")
        ...
        .start(LocalDateValidatorFactory.getInstance())
        .matchFields("t10")
        .errorMessage("test")
        .group("t10")
        .param("yyyy-MM-dd")
    ...
    {
      CellValidator v3 = (CellValidator) validators.get(2);
    ...
    {
      UnionCellValidator v4 = (UnionCellValidator) validators.get(3);
    ...
    {
      CellValidator v5 = (CellValidator) validators.get(4);
    ...
    {
      CellValidator v6 = (CellValidator) validators.get(5);
    ...
    {
      CellValidator v7 = (CellValidator) validators.get(6);
    ...
    {
      CellValidator v8 = (CellValidator) validators.get(7);
    ...
    {
      CellValidator v9 = (CellValidator) validators.get(8);
    ...
    {
      CellValidator v10 = (CellValidator) validators.get(9);
    ...
    {
      CellValidator v11 = (CellValidator) validators.get(10);
    ...
    {
      CellValidator v12 = (CellValidator) validators.get(11);
    ...
    {
      CellValidator v13 = (CellValidator) validators.get(12);
    ...
    {
      CellValidator v14 = (CellValidator) validators.get(13);
