...
public class DefaultWorkbookComposerTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(DefaultWorkbookComposerTest.class);
  ...
  public void testCompose() throws Exception {
    ...
    WorkbookComposer workbookComposer = new DefaultWorkbookComposer();

    SheetComposer<TestBean> sheetComposer = new DefaultSheetComposer<>();

    DefaultSheetComposerTest.addConverters(sheetComposer);
    ...
    Workbook workbook = workbookComposer
        .addSheetComposeHelper(sheetComposer)
        .addSheetComposeHelper(sheetComposer)
