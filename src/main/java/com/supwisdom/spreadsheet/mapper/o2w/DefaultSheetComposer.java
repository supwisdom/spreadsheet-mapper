...
public class DefaultSheetComposer<T> implements SheetComposer<T> {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(DefaultSheetComposer.class);
  ...
  @Override
  public SheetComposer<T> addFieldConverter(FieldConverter<T> fieldConverter) {
