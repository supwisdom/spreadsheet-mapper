package com.supwisdom.spreadsheet.mapper.w2o.validation.engine;
 ...
 */
public class ValidatorCyclicDependencyChecker {
  ...
  public ValidatorCyclicDependencyChecker(LinkedHashMap<String, LinkedHashSet<String>> vGraph) {
    this.vGraph = vGraph;
