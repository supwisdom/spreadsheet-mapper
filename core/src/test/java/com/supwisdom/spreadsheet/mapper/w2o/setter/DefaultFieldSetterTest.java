 ...
 */
public class DefaultFieldSetterTest {
  ...
  public void testSetValue(String field, String cellValue, Object expected) throws Exception {

    DefaultFieldSetter setter = new DefaultFieldSetter();
    TestBean testBean = new TestBean();
    setter.setValue(testBean, new CellBean(cellValue), new FieldMetaBean(field, 1));
