...
public class FieldScopeValidatorTest {
  ...
  public Object[][] testValidateParam() {
    ...
    return new Object[][] {
        ...
        new Object[] { new String[0], new String[] { "a" }, false },
  ...
  public void testValidate(String[] fieldScopes, String[] fieldNames, boolean expected) {

    FieldScopeValidator validator = new FieldScopeValidator(fieldScopes);
