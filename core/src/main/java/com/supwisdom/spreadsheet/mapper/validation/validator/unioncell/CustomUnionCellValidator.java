 ...
 * extends this will skip custom validate when multi cell value is all blank, like {@link CustomCellValidator#validate(Cell, FieldMeta)}
 * </pre>
 * Created by hanwen on 2017/1/20.
 */
public abstract class CustomUnionCellValidator<V extends CustomUnionCellValidator<V>> implements UnionCellValidator {
