...
``` groovy
compile 'com.supwisdom:spreadsheet-mapper-core:1.0.9-SNAPSHOT'
compile 'com.supwisdom:spreadsheet-mapper-java8:1.0.9-SNAPSHOT'
compile 'com.supwisdom:spreadsheet-mapper-joda:1.0.9-SNAPSHOT'
```
